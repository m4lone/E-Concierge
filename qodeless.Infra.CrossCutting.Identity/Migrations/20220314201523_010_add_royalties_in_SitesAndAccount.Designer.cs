...
namespace qodeless.Infra.CrossCutting.Identity.Migrations
{
    ...
    [Migration("20220314201523_010_add_royalties_in_SitesAndAccount")]
    partial class _010_add_royalties_in_SitesAndAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("qodeless.domain.Entities.Expense", b =>
                {
                    ...
                    b.Property<double>("FrequencyParcels")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("qodeless.domain.Entities.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("qodeless.domain.Entities.ResponsePix", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("qodeless.domain.Entities.VirtualBalance", b =>
                {
                    ...
                    b.Property<Guid?>("VouscherId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("VouscherId");
            ...
            modelBuilder.Entity("qodeless.domain.Entities.Income", b =>
                {
                    ...
                    b.HasOne("qodeless.domain.Entities.IncomeType", "IncomeType")
                        .WithMany()
            ...
            modelBuilder.Entity("qodeless.domain.Entities.VirtualBalance", b =>
                {
                    b.HasOne("qodeless.domain.Entities.Vouscher", "Vouscher")
                        .WithMany()
                        .HasForeignKey("VouscherId");

                    b.Navigation("Vouscher");
                });
